        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-10 items-center">
                    <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 text-sm uppercase font-bold cursor-pointer" href="{{route('posts.create')}}">
                    ...
                    <a class="font-bold uppercase text-gray-600 text-sm" href="{{route('posts.index', auth()->user()->username)}}">
                        <span class="font-normal normal-case">{{auth()->user()->username}}</span>
                    </a>
